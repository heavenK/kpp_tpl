...
switch ($r_step) { 
	...
	case "step3" : 
		...
		if (kekezu::submitcheck($formhash)) {
			...
			keke_msg_class::send_private_message ("您收到直接雇佣任务","您收到威客".$username."发给您的直接雇佣任务，<a href=\"index.php?do=task&task_id=".$task_id."\">《".$txt_title."》</a>。", $to_user_info[uid], $to_user_info[username],'','','ajax');
