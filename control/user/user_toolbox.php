...
switch ($show) {
	case 'buy' :
		...
		if ($item_code) { 
			in_array ( $item_code, array ('top', 'urgent', 'workhide', 'map','seohide' ) ) or kekezu::show_msg ( $_lang ['operate_notice'], 'index.php?do=user&view=payitem&op=toolbox', 3, $_lang ['param_error'], 'warning' );
