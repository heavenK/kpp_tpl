...
class MBOpenTOAuth {
    ...
    function authenticateURL() { return 'http://openapi.qzone.qq.com/oauth/qzoneoauth_authorize?oauth_consumer_key=$appid&'; } 
    function authorizeURL()    { return 'http://openapi.qzone.qq.com/oauth/qzoneoauth_authorize?oauth_consumer_key=$appid&'; } 
	...
	function jsonDecode($response, $assoc=true)	{
	 ...
	 switch ($ret) {
			...
			case 1:
				...
				break;
			case 2:
				return array('msg'=>'频率受限');
				//throw new Exception('频率受限!');
				break;
			case 3:
				return array('msg'=>'鉴权失败');
				//throw new Exception('鉴权失败!');
				break;
			case 4:
				return array('msg'=>'服务器内部错误');
				//throw new Exception('鉴权失败!');
				break;
			case 5:
				return array('msg'=>'用户错误');
				//throw new Exception('鉴权失败!');
				break;
			case 7:
				return array('msg'=>'未实名认证');
				//throw new Exception('鉴权失败!');
				break;
			default:
				...
				{
					if (KEKE_DEBUG){
						throw new Exception("发表失败,错误代码:".$errcode);
						break;
					}
