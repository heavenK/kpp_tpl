...
class keke_glob_class {
	...
	public static function get_finance_action() {
		...
		'deposit_return'=>$_lang['deposit_return'],'host_return'=>$_lang['host_return'],'cancel_bid'=>'撤销中标','pub_word'=>'提交稿件','choose_back'=>'中标返还奖励','choose_sucess'=>'成功选稿奖励',
		...
		'send_money'=>'托管赏金','finish_contect'=>'完善资料','send_credits'=>'豆币转让','fill_skills'=>'完善技能','first_service'=>'完善服务','first_anli'=>'完善案例','first_news'=>'完善新闻','shop_open_credit'=>'开通工作室',
