...
$return_url = $_K ['siteurl'] . '/payment/yeepay/callback.php';  //回调地址
...
<button type='submit' class='hidden' name='v_action' value='确认付款' onClick='document.forms["yeepay"].submit();'>确认付款</button>
</form>
